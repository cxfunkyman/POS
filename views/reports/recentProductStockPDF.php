...
<body>
    ...
    <h5 class="title">Recent Product Details</h5>
        ...
        <tbody>
            ...
            foreach ($data['products'] as $product) { ?>
                <tr class="summaryTbl">
                    ...
                    <td><?php echo CURRENCY . number_format($product['purchase_price'], 2,); ?></span></td>
                    <td><?php echo CURRENCY . number_format($product['sale_price'], 2,); ?></span></td>
